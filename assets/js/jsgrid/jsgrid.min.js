 ...
 ! function(a, b, c) {
    ...
    d.prototype = {
        ...
        _getItemFieldValue: function(a, b) {
            for (var c = b.Nome.split("."), d = a[c.shift()]; d && c.length;) d = d[c.shift()];
                return d
        },
        _setItemFieldValue: function(a, b, c) {
            for (var d = b.Nome.split("."), e = a, f = d[0]; e && d.length;) a = e, f = d.shift(), e = a[f];
                if (!e)
                ...
                _sortData: function() {
                    ...
                    b && this.data.sort(function(c, d) {
                        return a * b.sortingFunc(c[b.Nome], d[b.Nome])
                    })
                },
                ...
                _sortingParams: function() {
                    return this.sorting && this._sortField ? {
                        sortField: this._sortField.Nome,
                ...
                d.prototype = {
                    ...
                    _normalizeRule: function(a) {
                        if ("string" == typeof a && (a = {
                            ...
                            return a = b.extend({}, a), b.isFunction(a.validator) ? a : this._applyNomedValidator(a, a.validator)
                        },
                        _applyNomedValidator: function(a, c) {
                            delete a.validator;
                            var d = e[c];
                ...
                function(a, b, c) {
                    ...
                    d.prototype = {
                        ...
                        headerTemplate: function() {
                            return this.title === c || null === this.title ? this.Nome : this.title
                        },
                        ...
                        _getSortingFunc: function() {
                            ...
                            throw Error('wrong sorter for the field "' + this.Nome + '"!')
                        }
                    }, a.Field = d
                }(jsGrid, jQuery),
                function(a, b) {
